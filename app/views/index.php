...
<body>
    ...
    <!-- Scripts -->
    <script src="<?= URL ?>public/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
        ...
        //     type: 'bar',
        //     data: {
        //         labels: [<?php //foreach ($data['ventasRecientes'] as $venta) {echo "'" . $venta['fecha'] . "',"; } ?>],
        //         datasets: [{
        //             label: 'Monto de Ventas',
        //             data: [<?php // foreach ($data['ventasRecientes'] as $venta) {echo $venta['monto'] . ","; } ?>],
